...
class GreedyHillClimb(BaseAttack):
    """
        ...
        Parameters:
            ...
            num_directions : int, default=100
    ...
    def _sample_directions(
        ...
        """
            ...
            num_directions : int | None, default=None
                Number of candidate perturbations to generate. If None, `self.num_directions`
                is used.
        ...
        """
        num_directions = num_directions or self.num_directions
    ...
    def _generate(self, x: np.ndarray) -> np.ndarray:
        """
            ...
            Workflow:
                ...
                3) For `num_climbs` steps:
                    - sample `num_directions` candidate perturbations around `current_x`
        ...
        for _ in range(self.max_trys):
            ...
            for _ in range(self.num_climbs):
                ...
                candidates = self._sample_directions(current_x, num_directions = self.num_directions)
